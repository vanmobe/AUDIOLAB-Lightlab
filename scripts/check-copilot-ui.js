...
;async (page) => {
  ...
  await page.waitForFunction(() => !document.querySelector('[aria-label="Copilot-model"]')?.disabled, null, {
    timeout: 30000,
  })
  ...
  await page.waitForFunction(
    () => document.querySelector('.proposal-review') || document.querySelector('.design-assistant [role="alert"]'),
    null,
    { timeout: 60000 },
  )
  ...
  assert(
    ...
    'Cloud proposal never mutates show',
  )
