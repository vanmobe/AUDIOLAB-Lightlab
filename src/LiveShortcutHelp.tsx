...
export function LiveShortcutHelp({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  if (!open) return null
  return (
    <div className="live-shortcut-overlay">
      <section className="live-shortcut-help" role="dialog" aria-modal="true" aria-labelledby="live-shortcut-title">
        <header>
          <div>
            <p className="section-label">LIVEBEDIENING</p>
            <h2 id="live-shortcut-title">Snelle toetsen</h2>
          </div>
        ...
        <dl>
          <div>
            ...
            <dd>Vorige / volgende Look</dd>
          </div>
          <div>
            <dt>
              <kbd>Spatie</kbd>
            </dt>
            <dd>Show afspelen / beeld vasthouden</dd>
          </div>
          <div>
            <dt>
              <kbd>B</kbd>
